...
export const STAGES = [
  { id: 'intro3d', title: '开场动画', desc: '3D 鹈鹕骑车 + 结束页开始按钮', phase: 'Phase 3', shellNav: false },
  { id: 'map', title: '今晚的路线', desc: '四站赏月路线图', phase: 'Phase 4' },
  ...
  { id: 'spot4', title: '吴山城隍阁', desc: '第 4 站 · 城山揽月', phase: 'Phase 4' },
